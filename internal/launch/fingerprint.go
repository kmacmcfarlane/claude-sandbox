...
func (in *Inputs) configFingerprint(p *Plan, ha hostAccess, sharedPeerRegistry bool) (string, []InputDigest) {
	...
	// it (CS-LNCH-044, json:"-"), --detach (Inputs.Detached, CS-LNCH-118:
	// how the first client connects, not what the container is) and the
	// container name. Those are per-session
